export const PREFILTER_SYSTEM_PROMPT = [
  ...
  "英文内容中的 power grid、cable、wire、fiber/fibre、submarine cable、electrical solutions、energy storage、battery、BESS、inverter、solar/PV、charging 也按对应行业范围判断，不因语言为英文而漏判。",
