...
| ------ | ------------------ | ------------------------------------ | -------: | ---------- | -------------------------- |
| P0     | 中天科技官方新闻   | competitors/products（含海缆、储能） |        3 | 2026-07-22 | 落库，部署后正式烟测       |
| P0     | 江南电缆官方新闻   | competitors/products                 |       10 | 2026-07-09 | 落库，部署后正式烟测       |
| P1     | 起帆电缆官方新闻   | competitors/products                 |        5 | 2026-04-20 | 落库但保持禁用，等待新内容 |
| P0     | CNESA 储能行业资讯 | industry_policy/products             |        6 | 2026-07-28 | 落库，替代旧无列表日期入口 |
| P0     | 阳光电源官方新闻   | competitors/downstream/products      |        5 | 2026-07-09 | 落库，部署后正式烟测       |
| P0     | 海博思创官方新闻   | competitors/downstream/products      |        3 | 2026-07-30 | 落库，部署后正式烟测       |
| P0     | 国轩高科官方新闻   | competitors/upstream/products        |        6 | 2026-07-31 | 落库，部署后正式烟测       |

- 本批不新增远东电缆。
- 亨通、宝胜、金杯等继续留在后续批次：只在官方列表具备可追溯日期且生产解析不少于 3 条后落库。
- 生产预检只证明当前网络和解析结构可用，不替代 migration 部署后的 source ID 级验证与七日稳定性。
